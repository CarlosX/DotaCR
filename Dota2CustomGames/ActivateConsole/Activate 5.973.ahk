...
FileReadLine, vHostLine, options.ini, 6
...
{
	FileAppend, `n`n----ERROR LOG----`n`nvError1 = %vError1%`nvError2 = %vError2%`nvError3 = %vError3%`nvError4 = %vError4%`nvError5 = %vError5%`nvError6 = %vError6%`nvError7 = %vError7%`nvError8 = %vError8%`nvError9 = %vError9%`nvError10 = %vError10%`nvError11 = %vError11%`nvCount = %vCount%`nvTeam = %vTeam%`nvTeam2 = %vTeam2%`nvDirectory = %vDirectory%`nvDirectoryLoop = %vDirectoryLoop%`nvCharacterPosistion = %vCharacterPosistion%`nvToggle = %vToggle%`nvToggleCheck = %vToggleCheck%`nvServerName = %vServerName%`nvConnect = %vConnect%`nvDota = %vDota%`nvPixel1 = %vPixel1%`nvPixel2 = %vPixel2%`nvPixel3 = %vPixel3%`nvPixel4 = %vPixel4%`nvXP1 = %vXP1%`nvXP2 = %vXP2%`nvXP3 = %vXP3%`nvXP4 = %vXP4%`nvPixel1b = %vPixel1b%`nvPixel2b = %vPixel2b%`nvPixel3b = %vPixel3b%`nvPixel4b = %vPixel4b%`n, error.log.txt
	sleep, 50
...
{
	FileAppend, `n`n----ERROR LOG----`n`nvError1 = %vError1%`nvError2 = %vError2%`nvError3 = %vError3%`nvError4 = %vError4%`nvError5 = %vError5%`nvError6 = %vError6%`nvError7 = %vError7%`nvError8 = %vError8%`nvError9 = %vError9%`nvError10 = %vError10%`nvError11 = %vError11%`nvError9 = %vError9%`nvError10 = %vError10%`nvError11 = %vError11%`nvCount = %vCount%`nvTeam = %vTeam%`nvTeam2 = %vTeam2%`nvDirectory = %vDirectory%`nvDirectoryLoop = %vDirectoryLoop%`nvCharacterPosistion = %vCharacterPosistion%`nvToggle = %vToggle%`nvToggleCheck = %vToggleCheck%`nvServerName = %vServerName%`nvConnect = %vConnect%`nvDota = %vDota%`nvPixel1 = %vPixel1%`nvPixel2 = %vPixel2%`nvPixel3 = %vPixel3%`nvPixel4 = %vPixel4%`nvXP1 = %vXP1%`nvXP2 = %vXP2%`nvXP3 = %vXP3%`nvXP4 = %vXP4%`nvPixel1b = %vPixel1b%`nvPixel2b = %vPixel2b%`nvPixel3b = %vPixel3b%`nvPixel4b = %vPixel4b%`n, error.log.txt
	sleep, 50
	BlockInput, Off
	IfWinExist, ActivateConsole
	    WinActivate
