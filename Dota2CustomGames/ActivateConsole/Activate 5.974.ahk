...
FileReadLine, vName, options.ini, 5
if ErrorLevel = 1
    vError12 := 1
...
if (vError1 = 1) or (vError2 = 1) or (vError3 = 1) or (vError4 = 1) or (vError5 = 1) or (vError6 = 1) or (vError7 = 1) or (vError8 = 1) or (vError9 = 1) or (vError10 = 1) or (vError11 = 1) or (vError9 = 1) or (vError10 = 1) or (vError11 = 1)
{
	FileAppend, `n`n----ERROR LOG----`n`nvError1 = %vError1%`nvError2 = %vError2%`nvError3 = %vError3%`nvError4 = %vError4%`nvError5 = %vError5%`nvError6 = %vError6%`nvError7 = %vError7%`nvError8 = %vError8%`nvError9 = %vError9%`nvError10 = %vError10%`nvError11 = %vError11%`nvError12 = %vError12%`nvCount = %vCount%`nvTeam = %vTeam%`nvTeam2 = %vTeam2%`nvDirectory = %vDirectory%`nvDirectoryLoop = %vDirectoryLoop%`nvCharacterPosistion = %vCharacterPosistion%`nvToggle = %vToggle%`nvToggleCheck = %vToggleCheck%`nvServerName = %vServerName%`nvConnect = %vConnect%`nvDota = %vDota%`nvPixel1 = %vPixel1%`nvPixel2 = %vPixel2%`nvPixel3 = %vPixel3%`nvPixel4 = %vPixel4%`nvXP1 = %vXP1%`nvXP2 = %vXP2%`nvXP3 = %vXP3%`nvXP4 = %vXP4%`nvPixel1b = %vPixel1b%`nvPixel2b = %vPixel2b%`nvPixel3b = %vPixel3b%`nvPixel4b = %vPixel4b%`nvAscii = %vAscii%`n, error.log.txt
	sleep, 50
		...
		else
		{
			if (vPixel1 != 0x000000) or (vPixel2 != 0x000000) or (vPixel3 != 0x000000) or (vPixel4 != 0x000000)
			{
				...
				if (vPixel1 != 0x000000) or (vPixel2 != 0x000000) or (vPixel3 != 0x000000) or (vPixel4 != 0x000000)
				{
					...
					;    SendInput {%vToggle%}				
					sleep, 200
					PixelGetColor, vPixel1b, 2, 2
					PixelGetColor, vPixel2b, 2, 5
					PixelGetColor, vPixel3b, 5, 2
					PixelGetColor, vPixel4b, 5, 5
					if (vPixel1b != vPixel1) or (vPixel2b != vPixel2) or (vPixel3b != vPixel3) or (vPixel4b != vPixel4)
					{
						sleep, 50
						BlockInput, On
						IfWinExist, DOTA 2
						...
						sleep, 50
						IfWinExist, DOTA 2
						    SendInput say %vName% has joined %vTeam%
						sleep, 50
						IfWinExist, DOTA 2
						    SendInput {enter}
						sleep, 50
					...
					{
						GuiControl Text, vText1, %vTeam2%
						GuiControl Text, vText2, console button error
						GuiControl Text, vText3, %vTeam2%
						GuiControl Hide, vText2
...
if (vError1 = 1) or (vError2 = 1) or (vError3 = 1) or (vError4 = 1) or (vError5 = 1) or (vError6 = 1) or (vError7 = 1) or (vError8 = 1) or (vError9 = 1) or (vError10 = 1) or (vError11 = 1)
{
	FileAppend, `n`n----ERROR LOG----`n`nvError1 = %vError1%`nvError2 = %vError2%`nvError3 = %vError3%`nvError4 = %vError4%`nvError5 = %vError5%`nvError6 = %vError6%`nvError7 = %vError7%`nvError8 = %vError8%`nvError9 = %vError9%`nvError10 = %vError10%`nvError11 = %vError11%`nvError12 = %vError12%`nvError9 = %vError9%`nvError10 = %vError10%`nvError11 = %vError11%`nvError12 = %vError12%`nvCount = %vCount%`nvTeam = %vTeam%`nvTeam2 = %vTeam2%`nvDirectory = %vDirectory%`nvDirectoryLoop = %vDirectoryLoop%`nvCharacterPosistion = %vCharacterPosistion%`nvToggle = %vToggle%`nvToggleCheck = %vToggleCheck%`nvServerName = %vServerName%`nvConnect = %vConnect%`nvDota = %vDota%`nvPixel1 = %vPixel1%`nvPixel2 = %vPixel2%`nvPixel3 = %vPixel3%`nvPixel4 = %vPixel4%`nvXP1 = %vXP1%`nvXP2 = %vXP2%`nvXP3 = %vXP3%`nvXP4 = %vXP4%`nvPixel1b = %vPixel1b%`nvPixel2b = %vPixel2b%`nvPixel3b = %vPixel3b%`nvPixel4b = %vPixel4b%`nvAscii = %vAscii%`n, error.log.txt
	sleep, 50
	BlockInput, Off
	IfWinExist, ActivateConsole
	    WinActivate
...
else if (vError1 != 1) and (vError2 != 1) and (vError3 != 1) and (vError4 != 1) and (vError5 != 1) and (vError6 != 1) and (vError7 != 1) and (vError8 != 1) and (vError9 != 1) or (vError10 = 1) or (vError11 = 1)
{
	FileAppend, `n`n----VAR LOG----`n`nvError1 = %vError1%`nvError2 = %vError2%`nvError3 = %vError3%`nvError4 = %vError4%`nvError5 = %vError5%`nvError6 = %vError6%`nvError7 = %vError7%`nvError8 = %vError8%`nvError9 = %vError9%`nvError10 = %vError10%`nvError11 = %vError11%`nvError12 = %vError12%`nvCount = %vCount%`nvTeam = %vTeam%`nvTeam2 = %vTeam2%`nvDirectory = %vDirectory%`nvDirectoryLoop = %vDirectoryLoop%`nvCharacterPosistion = %vCharacterPosistion%`nvToggle = %vToggle%`nvToggleCheck = %vToggleCheck%`nvServerName = %vServerName%`nvConnect = %vConnect%`nvDota = %vDota%`nvPixel1 = %vPixel1%`nvPixel2 = %vPixel2%`nvPixel3 = %vPixel3%`nvPixel4 = %vPixel4%`nvXP1 = %vXP1%`nvXP2 = %vXP2%`nvXP3 = %vXP3%`nvXP4 = %vXP4%`nvPixel1b = %vPixel1b%`nvPixel2b = %vPixel2b%`nvPixel3b = %vPixel3b%`nvPixel4b = %vPixel4b%`nvAscii = %vAscii%`n, error.log.txt
}