...
vTeam2= nothing
vDirectory= nothing
vDirectoryLoop= nothing
vCharacterPosistion= nothing
vToggle= nothing
vToggleCheck= nothing
vServerName= nothing
vConnect= nothing
vDota := 0
vPixel1= nothing
...
Gui, Add, text, x70 y180 w500 vvText3, 1.2.7D
...
Loop
{
	...
	if (vDota = 3)
	{
		FileAppend, Successful Launch`n`n----VAR LOG----`n`nvError1 = %vError1%`nvError2 = %vError2%`nvError3 = %vError3%`nvError4 = %vError4%`nvError5 = %vError5%`nvError6 = %vError6%`nvError7 = %vError7%`nvError8 = %vError8%`nvCount = %vCount%`nvTeam = %vTeam%`nvTeam2 = %vTeam2%`nvDirectory = %vDirectory%`nvDirectoryLoop = %vDirectoryLoop%`nvCharacterPosistion = %vCharacterPosistion%`nvToggle = %vToggle%`nvToggleCheck = %vToggleCheck%`nvServerName = %vServerName%`nvConnect = %vConnect%`nvDota = %vDota%`nvPixel1 = %vPixel1%`nvPixel2 = %vPixel2%`nvPixel3 = %vPixel3%`nvPixel4 = %vPixel4%`n, error.log.txt
		sleep, 50
		IfWinExist, ActivateConsole
		    WinActivate
		IfWinExist, ActivateConsole
...
BlockInput, Off
sleep, 10
FileAppend, Connected to Server`, Could not join team Automatically.`nPressed the button to Join Team`n`n----VAR LOG----`n`nvError1 = %vError1%`nvError2 = %vError2%`nvError3 = %vError3%`nvError4 = %vError4%`nvError5 = %vError5%`nvError6 = %vError6%`nvError7 = %vError7%`nvError8 = %vError8%`nvCount = %vCount%`nvTeam = %vTeam%`nvTeam2 = %vTeam2%`nvDirectory = %vDirectory%`nvDirectoryLoop = %vDirectoryLoop%`nvCharacterPosistion = %vCharacterPosistion%`nvToggle = %vToggle%`nvToggleCheck = %vToggleCheck%`nvServerName = %vServerName%`nvConnect = %vConnect%`nvDota = %vDota%`nvPixel1 = %vPixel1%`nvPixel2 = %vPixel2%`nvPixel3 = %vPixel3%`nvPixel4 = %vPixel4%`n, error.log.txt
sleep, 50
IfWinExist, ActivateConsole
    WinActivate
IfWinExist, ActivateConsole
...
sleep, 50
BlockInput, Off
FileAppend, er010 - User pressed Cancel`n`n----VAR LOG----`n`nvError1 = %vError1%`nvError2 = %vError2%`nvError3 = %vError3%`nvError4 = %vError4%`nvError5 = %vError5%`nvError6 = %vError6%`nvError7 = %vError7%`nvError8 = %vError8%`nvCount = %vCount%`nvTeam = %vTeam%`nvTeam2 = %vTeam2%`nvDirectory = %vDirectory%`nvDirectoryLoop = %vDirectoryLoop%`nvCharacterPosistion = %vCharacterPosistion%`nvToggle = %vToggle%`nvToggleCheck = %vToggleCheck%`nvServerName = %vServerName%`nvConnect = %vConnect%`nvDota = %vDota%`nvPixel1 = %vPixel1%`nvPixel2 = %vPixel2%`nvPixel3 = %vPixel3%`nvPixel4 = %vPixel4%`n, error.log.txt
IfWinExist, ActivateConsole
    WinActivate
IfWinExist, ActivateConsole
    ExitApp
